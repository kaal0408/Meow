...
@Client.on_message(filters.user(SUDO_USERS) & filters.command(["rloho"], prefixes=HNDLR))
@Client.on_message(filters.me & filters.command(["rlogo"], prefixes=HNDLR))
async def rlogo(client: Client, message: Message):
    ...
    if message.reply_to_message:
        await client.send_photo(
            message.chat.id,
            photo=file_name,
            caption="Made Using Meow Userbot",
            reply_to_message_id=message.reply_to_message.message_id,
        )
    else:
        await client.send_photo(
            message.chat.id, photo=file_name, caption="Made Using Meow Userbot"
        )
