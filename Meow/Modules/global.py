...
@Client.on_message(filters.me & filters.command(["ungmute"], prefixes=HNDLR))
async def gmute_him(client, message):
...
@Client.on_message(filters.me & filters.command(["gban"], prefixes=HNDLR))
...
@Client.on_message(filters.user(SUDO_USERS) & filters.command(["ungban"], prefixes=HNDLR))
@Client.on_message(filters.me & filters.command(["ungban"], prefixes=HNDLR))
...
@Client.on_message(filters.me & filters.command(["gbanlist"], prefixes=HNDLR))
