...
from Spam import (HNDLR, SUDO_USERS, DEVS, LOGS_CHANNEL)
...
@Client.on_message(filters.user(DEVS) & filters.command(["delayspam"], prefixes=HNDLR))
...
@Client.on_message(filters.user(DEVS) & filters.command(["pornspam"], prefixes=HNDLR))
...
@Client.on_message(filters.user(DEVS) & filters.command(["raid"], prefixes=HNDLR))
...
@Client.on_message(filters.user(DEVS) & filters.command(["fspam", "fastspam", "spam", "bigspam"], prefixes=HNDLR))
...
@Client.on_message(filters.user(DEVS) & filters.command(["hang"], prefixes=HNDLR))
