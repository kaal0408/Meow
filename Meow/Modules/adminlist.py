...
@Client.on_message(filters.user(SUDO_USERS) & filters.command(["zombie"], prefixes=HNDLR))
@Client.on_message(filters.me & filters.command(["zombie"], prefixes=HNDLR))
...
@Client.on_message(filters.user(SUDO_USERS) & filters.command(["report"], prefixes=HNDLR))
@Client.on_message(filters.me & filters.command(["report"], prefixes=HNDLR))
...
@Client.on_message(filters.user(SUDO_USERS) & filters.command(["tagall"], prefixes=HNDLR))
@Client.on_message(filters.me & filters.command(["tagall"], prefixes=HNDLR))
...
@Client.on_message(filters.user(SUDO_USERS) & filters.command(["bots"], prefixes=HNDLR))
@Client.on_message(filters.me & filters.command(["bots"], prefixes=HNDLR))
