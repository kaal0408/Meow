...
@Client.on_message(filters.user(SUDO_USERS) & filters.command(["stats"], prefixes=HNDLR))
@Client.on_message(filters.me & filters.command(["stats"], prefixes=HNDLR))
...
⚠️**ꜰᴇᴀᴛᴄʜᴇᴅ ʙʏ ᴜꜱɪɴɢ Meow userbotot**""".format(
